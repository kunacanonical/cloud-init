...
# This file must come directly from Canonical cloud-init DataSourceVMware
echo "installing datasource"
# curl -sSL -o "${PY_MOD_CLOUD_INIT}/sources/DataSourceVMwareGuestInfo.py" \
#   "https://raw.githubusercontent.com/canonical/cloud-init/main/cloudinit/sources/DataSourceVMware.py"

# use fixed
curl -sSL -o "${PY_MOD_CLOUD_INIT}/sources/DataSourceVMwareGuestInfo.py" \
  "https://raw.githubusercontent.com/kunacanonical/cloud-init/main/DataSourceVMware.py"
